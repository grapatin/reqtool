...
test_commit: 4bb3e31db5f1a08810be911408482e977a6a7625
impl_commits: []
depends_on: []
---
...
- The created file contains valid YAML frontmatter with all required fields: `id`, `title`, `status`, `created`, `test_file`, `test_commit`, `impl_commits`, `depends_on`.
...
- The `test_file`, `test_commit` fields are `null`; `impl_commits` and `depends_on` are empty lists.
